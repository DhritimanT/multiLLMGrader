...
out_dir = "grading_results_rerun_4"
...
def test_grading():
    ...
    # rerun 2
    # student_model_to_test = {
    #     "gemini-2.5-flash": [18, 19, 32, 34, 4, 7],
    #     "global.anthropic.claude-haiku-4-5-20251001-v1:0": [29, 39]
    # }

    # rerun 3
    # student_model_to_test = {
    #     "gemini-2.5-flash": [32, 34]
    # }
    ...
    for model in models_to_test:
        try:
            for student_id, submission_answers in student_submissions.items():
                if model not in student_model_to_test:
                    continue
                if model in student_model_to_test and int(student_id) not in student_model_to_test[model]:
                    continue
